...
const globalSettingsSchema = z.object({
  ...
  tokenInputUsdPer1M: numberFromInput(z.number().min(0.0001)),
  tokenOutputUsdPer1M: numberFromInput(z.number().min(0.0001)),
  tokenCachedInputUsdPer1M: numberFromInput(z.number().min(0)),
  tokenMarkupPercent: numberFromInput(z.number().min(0).max(200)),
  ...
  try {
    ...
    const settings = await prisma.globalSettings.upsert({
      ...
      update: {
        ...
        tokenInputUsdPer1M: parsed.data.tokenInputUsdPer1M,
        tokenOutputUsdPer1M: parsed.data.tokenOutputUsdPer1M,
        tokenCachedInputUsdPer1M: parsed.data.tokenCachedInputUsdPer1M,
        tokenMarkupPercent: parsed.data.tokenMarkupPercent,
