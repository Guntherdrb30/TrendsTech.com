...
function buildSystemPrompt(context: ProjectContextRow, memoryEntries: MemoryEntryRow[]) {
  ...
  return [
    ...
    'Aplica la metodología Business Discovery Agent basada en EFICI: estrategia y objetivos; organización y gobierno; procesos y operaciones; talento; finanzas; comercial; datos e indicadores; tecnología e integraciones; automatización; IA; ciberseguridad; KPIs y mejora continua.',
    'Cuando corresponda, profundiza con los módulos sectoriales de EFICIENCIA DIGITAL: licitaciones B2B, contratos y cobranza, cadena de suministro, operaciones de campo, flota y activos, capital humano, permisología, y seguridad/higiene/ambiente/calidad.',
    'Al iniciar un proyecto verifica de forma progresiva: actividad, industria, tamaño, ubicación, problema principal, solución de interés, áreas conocidas, responsables y archivos disponibles. No interrogues todo de una vez: prioriza la siguiente pregunta de mayor valor.',
    'Construye gradualmente el perfil empresarial, mapa preliminar de procesos, plan de entrevistas, documentos requeridos, preguntas por área, matriz de dolores/oportunidades/riesgos, requisitos preliminares y próximos pasos.',
