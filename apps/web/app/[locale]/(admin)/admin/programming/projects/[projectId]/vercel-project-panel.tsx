import type { VercelIntegrationSummary } from '@/lib/engineering-studio/infrastructure-sync';
...
type VercelEvent = { id: string; type: string; message: string | null; createdAt: Date };

export function VercelProjectPanel({ locale, projectId, integration, events }: {
  locale: string;
  projectId: string;
  integration: VercelIntegrationSummary | null;
  events: VercelEvent[];
}) {
