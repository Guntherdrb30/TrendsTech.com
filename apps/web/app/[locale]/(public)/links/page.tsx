  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden" aria-hidden="true">
        {/* Orb teal superior centro */}
        <div className="absolute -top-32 left-1/2 h-[700px] w-[700px] -translate-x-1/2 animate-pulse rounded-full bg-[radial-gradient(circle,rgba(0,191,165,0.10)_0%,transparent_65%)] blur-3xl" />
        {/* Orb índigo derecha */}
        <div
          className="absolute right-0 top-1/4 h-[450px] w-[450px] translate-x-1/3 animate-pulse rounded-full bg-[radial-gradient(circle,rgba(99,102,241,0.07)_0%,transparent_70%)] blur-3xl"
          style={{ animationDelay: '1.5s', animationDuration: '4s' }}
        />
        {/* Orb teal inferior izquierda */}
        <div
          className="absolute bottom-0 left-0 h-[400px] w-[400px] -translate-x-1/4 animate-pulse rounded-full bg-[radial-gradient(circle,rgba(0,191,165,0.06)_0%,transparent_70%)] blur-3xl"
      ...
      <main className="relative mx-auto flex min-h-screen max-w-md flex-col items-center px-5 py-14">
        ...
        {/* ── Stats ── */}
        <div className="reveal reveal-delay-1 mb-8 w-full">
        ...
        {/* ── Divisor ── */}
        <div className="reveal reveal-delay-2 mb-6 flex w-full items-center gap-3">
        ...
        {/* ── Links ── */}
        <div className="reveal reveal-delay-3 w-full space-y-3">
          {LINKS.map((link) => (
