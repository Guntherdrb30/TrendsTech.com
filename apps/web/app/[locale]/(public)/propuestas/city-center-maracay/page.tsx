      ...
      <main onContextMenu={undefined}>
        ...
        <section className="px-5 py-20 md:px-8 md:py-28">
          <div className="mx-auto max-w-5xl rounded-[36px] bg-[linear-gradient(135deg,#07111f,#0f2537)] px-7 py-14 text-center text-white md:px-14 md:py-20">
            ...
            <a href="mailto:root@carpihogar.com?subject=Propuesta%20LUNA%20for%20City%20Center" className="mt-9 inline-flex rounded-full bg-white px-6 py-3 text-sm font-bold text-slate-950">Solicitar reunión de trabajo</a>
          </div>
