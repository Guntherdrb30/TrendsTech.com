    ...
    <div className={className}>
      <form className="relative" onSubmit={handleSubmit}>
        ...
        <input
          ...
          autoComplete="off"
          spellCheck={false}
          className="w-full rounded-full border border-slate-200 bg-white/90 px-4 py-1.5 pr-10 text-xs text-slate-900 shadow-sm transition focus:border-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-200 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-100 dark:focus:border-teal-400 dark:focus:ring-teal-500/30"
        />
        <button
          type="submit"
          className="absolute right-2 top-1/2 flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-full text-slate-500 transition hover:text-slate-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-200 dark:text-slate-400 dark:hover:text-white dark:focus-visible:ring-teal-500/40"
        >
