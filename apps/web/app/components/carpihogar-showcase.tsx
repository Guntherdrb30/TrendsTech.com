...
const slides = [
  ...
  {
    src: '/cases/carpihogar/carpihogar-admin-dashboard.svg',
    altEs: 'Panel operativo de la implementación CarpiHogar',
    altEn: 'CarpiHogar implementation operations dashboard',
    labelEs: 'Operación centralizada',
    labelEn: 'Centralized operations',
    position: 'object-center',
  },
  {
    src: '/cases/carpihogar/carpihogar-catalog-grid.svg',
    altEs: 'Catálogo conectado de CarpiHogar',
    altEn: 'CarpiHogar connected catalog',
    labelEs: 'Catálogo conectado',
    labelEn: 'Connected catalog',
    position: 'object-center',
  },
  {
    src: '/cases/carpihogar/carpihogar-exec-reports.svg',
    altEs: 'Reportes ejecutivos de la implementación CarpiHogar',
    altEn: 'CarpiHogar implementation executive reports',
    labelEs: 'Inteligencia ejecutiva',
    labelEn: 'Executive intelligence',
    position: 'object-center',
  },
] as const;
